...
FIRSTSTEP_API UClass* Z_Construct_UClass_ACombatEnemySpawner();
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemySpawner_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatActivatable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemySpawner, ICombatActivatable), false },  // 3694079295
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Dev_Projet_1_UE5_Gameplay_Prototypes_firstStep_Source_firstStep_Variant_Combat_AI_CombatEnemySpawner_h__Script_firstStep_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemySpawner, ACombatEnemySpawner::StaticClass, TEXT("ACombatEnemySpawner"), &Z_Registration_Info_UClass_ACombatEnemySpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemySpawner), 1527540670U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Dev_Projet_1_UE5_Gameplay_Prototypes_firstStep_Source_firstStep_Variant_Combat_AI_CombatEnemySpawner_h__Script_firstStep_3869439147(TEXT("/Script/firstStep"),
	Z_CompiledInDeferFile_FID_Dev_Projet_1_UE5_Gameplay_Prototypes_firstStep_Source_firstStep_Variant_Combat_AI_CombatEnemySpawner_h__Script_firstStep_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Dev_Projet_1_UE5_Gameplay_Prototypes_firstStep_Source_firstStep_Variant_Combat_AI_CombatEnemySpawner_h__Script_firstStep_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
